...
const Login: React.FC = () => {
    ...
    const [logoUrl, setLogoUrl] = useState('https://trackfyapp.com.br/images/logo/logo-trackfy.svg');
    const { showAlert } = useAlert();
    const { setUser, theme } = useGlobals();
    ...
    useEffect(() => {
        if (theme === 'dark') {
            setLogoUrl('https://trackfyapp.com.br/images/logo/logo-cor-2.svg');
        } else {
            setLogoUrl('https://trackfyapp.com.br/images/logo/logo-trackfy.svg');
        }
    }, [theme]);
    ...
    return (
        ...
        >
            <div className="w-[80vw] min-h-screen pt-0 bg-gradient-to-t from-blue-900/50 to-blue-900/0 dark:from-gray-900/70 ">
                <img src={logoUrl} className="max-w-lg" alt="Trackfy Logo" />
            ...
            <Card className="w-full max-w-md shadow-lg min-h-screen  backdrop-blur-md justify-center">
                <CardHeader >
